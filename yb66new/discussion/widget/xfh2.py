...
from orangecontrib.xoppy.util.xoppy_xraylib_util2 import crystal_fh2, bragg_calc2
...
#X.J. Yu Singapore Synchrotorn Ligth Source
    ...
    def xoppy_calc_xfh(self):
        ...
        bragg_dictionary = bragg_calc2(descriptor=descriptor,hh=HMILLER,kk=KMILLER,ll=LMILLER,temper=TEMPER,
