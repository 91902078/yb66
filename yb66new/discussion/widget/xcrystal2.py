...
from orangecontrib.xoppy.util.xoppy_xraylib_util2 import bragg_calc2
...
class OWxcrystal(XoppyWidget):
    ...
    def build_gui(self):
        ...
        #widget index 26, crystal filename selection
        idx += 1 
        box1 = gui.widgetBox(box)

        file_box = oasysgui.widgetBox(box1, "", addSpace=False, orientation="horizontal", height=25)

        self.le_crystal_file = oasysgui.lineEdit(file_box, self, "CRYSTAL_FILE",
                     label=self.unitLabels()[idx], addSpace=False, orientation="horizontal")
        self.show_at(self.unitFlags()[idx], box1)

        gui.button(file_box, self, "...", callback=self.selectCrystalFile)
    ...
    def unitFlags(self):
         return ['False','True','True','True','True',
                 ...
                 'self.MOSAIC  ==  1',
                 'self.MOSAIC  >  1','self.MOSAIC  >  1','self.MOSAIC  >  1','self.MOSAIC  >  1  and  self.ANISOTROPY  ==  0',
                 'self.MOSAIC  >  1  and  self.ANISOTROPY  ==  2','self.MOSAIC  >  1  and  self.ANISOTROPY  ==  3','True']
    ...
    def selectCrystalFile(self):
        self.le_crystal_file.setText(oasysgui.selectFileFromDialog(self, self.CRYSTAL_FILE, "Select Crystal file", file_extension_filter="*.dat *.txt"))
